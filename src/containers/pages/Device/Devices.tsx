...
const Devices: React.FC<IDevices> = ({
    dispatch, deviceFormData, props, match, consumerData
}) => {
    ...
    function rowColumnClick(rowData) {
        window.location.href = "/threesixty/" + rowData.meterSerialNumber;
    }
                    ...
                    {!deviceFormData.isListLoading && (
                        <div>
                            {!isShowActivate && (
                                ...
                                >
                                    <Column body={dateTemplate} className="dtcolumnoverflow" field="meterSerialNumber" header="Serial Number" sortable={true} filter={true} filterMatchMode="contains" />
                                    <Column field="meterIp" header="Host Name" sortable={true} filter={true} filterMatchMode="contains"  />
                                    <Column className="dtcolumnoverflow" field="imeiNumber" header="IMEI" sortable={true} filter={true} filterMatchMode="contains"  />
                                    <Column field="phaseString" header="Phase" sortable={true} filter={true} filterMatchMode="contains"  />
                                    <Column field="aunthenticationType" header="Authentication Type" sortable={true} filter={true} filterMatchMode="contains"  />
                                    <Column field="sourceType" header="Source" sortable={true} filter={true} filterMatchMode="contains" />
                                    <Column field="connectionStatus" header="Connection Status" sortable={true} filter={true} filterMatchMode="contains" />
