...
<Dialog header="Update Settings" visible={displayDialog} style={{ overflow:'scroll' }} modal={true} onHide={() => setdisplayDialog(false) }>
            ...
            <label htmlFor="assignto">Setting Type</label>
        </div>
        <div className="p-col-12 p-md-4">

        <Dropdown options={settingType} id="userId"  autoWidth={false} />   

       </div>
        <div className="p-col-12 p-md-2">
            <label htmlFor="meterid">Amount </label>
        </div>
        <div className="p-col-12 p-md-4" style={{marginBottom:'10px'}}>
        <InputText id="amount" value={rowData.amount}/>   
        </div>
                ...
                <DataTable value={dataTableValues} paginatorPosition="both" selectionMode="single" 
                 ...
                 scrollable={true} scrollHeight="400px" style={{marginTop:'5px', width: '2000px'}}  header={header}
                    ...
                    >
                        ...
                        <Column field="unitrateeb" header="Unit Rate EB (Rs.)" filter={true} />
                        <Column field="unitratedg" header="Unit Rate DG (Rs.)" filter={true} />
                        <Column field="emergencytopup" header="Emergency TopUp (Rs.)" filter={true} />
                        <Column field="loadeb" header="Sanctioned Load EB (W)" filter={true} />
                        <Column field="loaddg" header="Sanctioned Load DG (W)" filter={true} />
                        <Column field="credittopup" header="Credit Top Up (Rs.)" filter={true} />
