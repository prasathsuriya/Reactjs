...
const  Actualblocksearch: React.FC<IMeterDailyLoadInformationReport> = ({
  dispatch,
  CIRCLEData ,
  DIVISIONData,
  SUBDIVISIONData,
  ...
  METERDATEData
   ...
   // alert(JSON.stringify(METERLOCATIONData.items.meterDetailsAutoid));
    if(ACTUALBLOCKLOADData.items.length>0){                
            ...
            // alert(JSON.stringify(METERLOCATIONData.items.meterDetailsAutoid));
             if(ACTUALBLOCKLOADData.items.length>0){                
               for(var i=0;i<ACTUALBLOCKLOADData.items.length;i++){
                 ...
                 var element=ACTUALBLOCKLOADData.items[i];
                 if(element.meterAutoid.meterSerialNumber==rowData.meterDetailsAutoid.meterSerialNumber){  
                     //alert(element.energyWhExport);
                   return <div>
                   <a >{element.energyWhExport}</a>
      ...
      const onCheckSelected=(rowData:any, column:any)=>{
        var meters=new Array<any>();
            // alert(JSON.stringify(METERLOCATIONData.items.meterDetailsAutoid));
             if(ACTUALBLOCKLOADData.items.length>0){                
               for(var i=0;i<ACTUALBLOCKLOADData.items.length;i++){
                        ...
                        >             
                         ...
                         <Column field="autoid" header="Id" sortable={true}/>
                            ...
                            <Column
                                             ...
                                             style={{ textAlign: "center", width: "8em" }}
                                            /> 
                            <Column field="" header="Average kwh" sortable={true}/>
                            <Column field="" header="Load Factor" sortable={true}/> 
             ...
             <DataTable
                        ...
                        >             
                         ...
                         <Column field="autoid" header="Id" sortable={true}/>
                            ...
                            <Column field="transformerAutoid.transformerName" header="Name of DT" sortable={true}/>
                            <Column field="noOfPowerFailures" header="Number of power failure" sortable={true}/>
                            <Column field="cumPowerOffDuration" header="Duration of power failure" sortable={true}/>  
...
export default connect(mapStateToProps)(Actualblocksearch);