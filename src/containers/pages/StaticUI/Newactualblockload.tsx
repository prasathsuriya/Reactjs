...
const  Newactualblockload: React.FC<IMonthlyConsumption> = ({
    dispatch,   ACTUALBLOCKLOADData
...
{"cano":"20191200010191","customername":"G1-004","blockno":"G1","flatno":"004","meterno":"0000805","maxloadeb":"3.000","maxloaddg":"1.000","dcuid":"6","balancekwh":"101.075","balanceinr":"470.00","loadcontrol":"ON","meteroperation":"EB (EB-0.168 / DG-0.000)","lastupdatetime":"11-02-2020 01:30:57","month":"01-2020","energyeb":"12.299","energydg":"0.039","mobileno":"8807247481","emailid":"murugavelt@acumentec.com"}
   ...
   loadGrid();
   function loadGrid(){
     if (!isPageLoaded && !ACTUALBLOCKLOADData.isLoading) {
                ...
                <DataTable value={tableData} paginatorPosition="both" selectionMode="single" 
                 ...
                 scrollable={true} scrollHeight="400px" style={{marginTop:'5px', width: '2000px'}}  header={header}
                    ...
                    >
                        ...
                        <Column field="energyWhImport" header="Energy Wh import" filter={true} />
                        <Column field="energyVahImport" header="Energy vah import" filter={true} />
                        <Column field="energyWhExport" header="Energy Wh export" filter={true} />
                        <Column field="energyVahExport" header="Energy vah export" filter={true} />
                        <Column field="statusByte" header="Status byte" filter={true} />
                        <Column field="averageSignalStrength" header="Average signal" filter={true} />
...
const mapStateToProps = (state: any) => {
    const { deviceFormData,ACTUALBLOCKLOADData } = state;
    return {
        deviceFormData,
        ACTUALBLOCKLOADData
    };
};
export default connect(mapStateToProps)(Newactualblockload);