...
const  Powerfactor: React.FC<IMeterDailyLoadInformationReport> = ({
  dispatch,
  CIRCLEData ,
  DIVISIONData,
  SUBDIVISIONData,
...
export default connect(mapStateToProps)(Powerfactor);