...
const  InActiveCustomer: React.FC<IInActiveCustomer> = ({
    ...
    <div>
         ...
         <div className="content-section introduction">
                    <div className="feature-intro">
                        <h1> Reports - InActive Customer</h1>
                    </div>
...
export default connect(mapStateToProps)(InActiveCustomer);