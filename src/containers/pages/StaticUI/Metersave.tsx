...
const  Metersave: React.FC<IWorkflows> = ({
    dispatch,
    ticketcategriesData,
 ...
 const [tableData, setTableData] = useState(new Array<any>());
  ...
  if (loggedInString) {
    ...
    if (loggedInData) {
      ...
      workflowData.companyAutoId = loggedInData.userProfile.userautoid.companyAutoid.id;
    }
  }
  useEffect(() => {
   ...
   //   alert(JSON.stringify(workflowData));
      // alert(JSON.stringify(ticketcategriesData.items));
       ...
       setTimeout(() => {
        ...
        window.location.href="/meter/meternewsearch";
        }, 4000);
       //alert("saved");
        }else{
...
<div className="p-col-12 p-md-2">
                      ...
                      <div className="p-grid">
                        ...
                        <div className="p-col-12 p-md-4">
                        <Dropdown id="authenticationtype" options={priority} onChange={handlenewInputChange}  value={workflowData.aunthenticationType} required  autoWidth={false} /> 
                        </div>
...
export default connect(mapStateToProps)(Metersave)