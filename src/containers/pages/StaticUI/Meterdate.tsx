...
const  Meterdate: React.FC<IMeterDailyLoadInformationReport> = ({
  dispatch,
  CIRCLEData ,
  DIVISIONData,
  SUBDIVISIONData,
                         ...
                         <Column field="autoid" header="Id" sortable={true}/>
                            ...
                            <Column
                                            ...
                                            <Column
                                             ...
                                             style={{ textAlign: "center", width: "8em" }}
                                            /> 
                            <Column field="" header="Average Power of Supply" sortable={true}/>
                            <Column field="" header="% Outage" sortable={true}/> 
...
export default connect(mapStateToProps)(Meterdate);